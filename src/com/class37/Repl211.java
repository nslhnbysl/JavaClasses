...
public class Repl211 {
	...
	public static void main(String[] args) {
		 ...
		 * 4: Create orangeMap<String, Object> and add below pairs into it.
		 * "Items","Orange" "Price", 21.99 "Quantity", 10 Step 5: Add orangeMap to
		 * dataList. Step 6: Create a loop from dataList. Step 7: Retrieve each Key and
		 * store is in a variable. Step 8: calculate the subtotal of each object. Step
		 * 9: Print the values of each Iteration same as shown below in Output example.
		 * Step 10: Calculate the Sum of subtotal. and store is in variable called
		 * totalPurchase. Step 11: After Loop Print the value of Total Purchase.
		 */
		...
		System.out.println("Your Purchase total : "
				+ ((Double) dataList.get(0).get("SubTotal") + (Double) dataList.get(1).get("SubTotal")));
	}
